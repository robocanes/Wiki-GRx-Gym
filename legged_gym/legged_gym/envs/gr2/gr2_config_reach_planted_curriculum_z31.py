...
class GR2ReachPlantedCurriculumZ31Cfg(GR2ReachPlantedCurriculumZ29Cfg):
    """Mid-low posture rehearsal after fixing the forward torso-pitch sign."""
...
class GR2ReachPlantedCurriculumZ31CfgPPO(
    GR2ReachPlantedCurriculumZ29CfgPPO,
    GR2ReachPlantedCurriculumZ31Cfg,
):
    class runner(GR2ReachPlantedCurriculumZ29CfgPPO.runner):
        experiment_name = "GR2Reach"
        num_steps_per_env = 48

        run_name = "planted_curriculum_z31_midlow_posture_signfix_from_z5_13746"
        max_iterations = 120
        save_interval = 10
    ...
    class policy(GR2ReachPlantedCurriculumZ29CfgPPO.policy):
        init_noise_std = [0.006] * GR2ReachPlantedCurriculumZ31Cfg.env.num_actions
