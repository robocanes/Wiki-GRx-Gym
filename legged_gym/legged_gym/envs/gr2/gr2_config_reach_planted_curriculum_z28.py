...
class GR2ReachPlantedCurriculumZ28Cfg(GR2ReachPlantedCurriculumZ27Cfg):
    """Posture-priority branch: learn forward mass shift before chasing lower targets hard."""
...
class GR2ReachPlantedCurriculumZ28CfgPPO(
    GR2ReachPlantedCurriculumZ27CfgPPO,
    GR2ReachPlantedCurriculumZ28Cfg,
):
    class runner(GR2ReachPlantedCurriculumZ27CfgPPO.runner):
        experiment_name = "GR2Reach"
        num_steps_per_env = 48

        run_name = "planted_curriculum_z28_posture_first_from_z17_15599"
        max_iterations = 120
        save_interval = 10
    ...
    class policy(GR2ReachPlantedCurriculumZ27CfgPPO.policy):
        init_noise_std = [0.008] * GR2ReachPlantedCurriculumZ28Cfg.env.num_actions
